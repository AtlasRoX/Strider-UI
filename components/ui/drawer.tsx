  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          'group/drawer-content fixed z-50 flex h-auto flex-col bg-[var(--surface-card)] text-[var(--ink-primary)] border-[var(--outline-base)] shadow-2xl',
        ...
        {...props}
      >
        <div className="bg-[var(--outline-base)] mx-auto mt-3 hidden h-1.5 w-12 shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
...
function DrawerFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('mt-auto flex flex-col gap-2 p-4 border-t border-[var(--outline-muted)]', className)}
      {...props}
    />
  )
}
